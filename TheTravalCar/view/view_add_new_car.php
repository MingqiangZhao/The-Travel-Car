            ...
            <?php include'fragmentMenuUser.html' ?>
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel-heading" align="center">
                            ...
                            <br>
                            <h5 class="text-muted">Add a new car for you ! The default car is the first car you added. However,you can change it</h5>
                            <br>
                            <hr>
                             <form role="form" method='post' action='../controller/router.php?action=add_new_car'>
